...
import { PlusCircle, CloudRain, Thermometer, AlertTriangle, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="navi-card p-4 rounded flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-purple-300 block">PRECIPITACIÓN ACUMULADA</span>
        ...
        <div className="navi-card p-4 rounded flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-purple-300 block">TEMPERATURA PROMEDIO</span>
        ...
        <div className="navi-card p-4 rounded flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-purple-300 block">ENFERMEDADES REGISTRADAS</span>
      ...
      <div className="navi-card p-5 rounded">
        <h2 className="text-lg font-bold text-yellow-400 mb-4 flex items-center gap-2 border-b border-purple-800 pb-2">
          <CloudRain className="w-5 h-5 text-cyan-400" /> REGISTRO AGROCLIMÁTICO Y FITOSANITARIO FOLIAR
        </h2>
          ...
          <table className="grid-table">
            ...
            <tbody>
              {records.length > 0 ? (
                ...
                <tr>
                  <td colSpan="9" className="text-center py-6 text-purple-300">
